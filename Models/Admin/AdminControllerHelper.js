...
var checkUserEmailExist = function(data, callback) {
    ...
    Service.makeModule.admin.view(criteria, projection, option, function(err, result) {
        if (err) {
            return callback(err)
...
var totalArticleCount = function(data, callback) {
    ...
    Service.makeModule.articles.count(criteria, function(err, total) {
        if (err) {
            return callback(err)
        }  else {
...
exports.totalArticleCount = totalArticleCount;


var totalUserCount = function(data, callback) {
    ...
    Service.makeModule.users.count(criteria, function(err, total) {
        if (err) {
            return callback(err)
        }  else {
...
var totalTripCount = function(data, callback) {
    ...
    Service.makeModule.trips.count(criteria, function(err, total) {
        if (err) {
            return callback(err)
        }  else {
            data.stats.trip = total;
            return callback(null, data);
        }
    });
};

exports.totalTripCount = totalTripCount;
...
var insertUserIntoDb = function(data, callback) {
    ...
    crypto.randomBytes(48, function(err, buffer) {
        ...
        if (err) {
            ...
            Service.makeModule.admin.add(data.payload, function(err, userDataFromDB) {
...
function updateUserData(criteria, setQuery, options, callback) {
    ...
    Service.makeModule.admin.edit(criteria, setQuery, options, function(err, data) {
...
function updateAccessToken(data, callback) {
    ...
    TokenManager.setTokenForAdmin(tokenData, function(err, output) {
        if (err) {
            callback(err);
...
var updateUserProfileData = function(data, callback) {
    ...
    Service.makeModule.admin.edit(criteria, data.payload, { new: true }, callback);
}
...
var updateNewCodeIntoDb = function(data, callback) {
    ...
    Service.makeModule.admin.edit(criteria, dataToSet, options, function(err, result) {
        if (err) {
            callback(err);
        } else {
...
var sendPasswordOnEmail = function(data, callback) {
    ...
    var msg = 'Hi ' + data.userData.name + ', welcome to Cartoq !<br/><br/>';
    ...
    var sub = 'Welcome on Cartoq, Your account is created successfully.';
...
var sendVerificationEmail = function(data, callback) {
    ...
    crypto.randomBytes(48, function(err, buffer) {
        ...
        // if (data.userData.userType != constant.APP_CONSTANTS.DATABASE.userType.organisationStudent && data.userData.userType != constant.APP_CONSTANTS.DATABASE.userType.individualStudent) {
        //     url = adminUrl + '/verify-email?token=' + token + '&email=' + urlEmail;
        // }
        ...
        Service.makeModule.admin.edit(criteria, setQuery, {}, function(err, result) {
...
var sendNewRegisterEmailToSuperAdmin = function(data, callback) {
    ...
    Service.makeModule.admin.view(criteria, {}, { lean: true }, function(err, result) {

        var url = 'http://dev.Cartoq.com/#!/app/users';
        var msg = 'Hi,<br/><br/>';
...
var getUserFromDb = function(data, callback) {
    ...
    criteria.population = [{ path: 'organisationId' }];

    Service.makeModule.admin.findOne(criteria, projection, option, function(err, result) {
        if (err) {
            return callback(err)
...
var updateNewPassword = function(data, callback) {
    ...
    Service.makeModule.admin.edit(data.criteria, setQuery, options, callback);
}
...
var updateForgotPasswordToken = function(data, callback) {
    ...
    Service.makeModule.admin.edit(data.criteria, setQuery, options, function(err, result) {
...
var getUserProfileData = function(data, callback) {
    ...
    Service.makeModule.admin.view(criteria, projection, options, function(err, result) {
